...
const Reports = () => {
  ...
  const getReports = async () => {
    ...
    try {
      const response = await axios.get(
        `https://api2.tuplrc-cla.com/api/reports/${userId}`
      );
  ...
  const handleSearch = (e) => {
    ...
    const filtered = reports.filter((report) => {
      ...
      const matchesCategory =
        selectedFilter.category == "any" ||
        report.cat_id == selectedFilter.category;

      const matchesStatus =
        selectedFilter.status == "any" ||
        report.is_archived == selectedFilter.status;
  ...
  const handleArchive = async (id, status) => {
    ...
    try {
      await axios.put(`https://api2.tuplrc-cla.com/api/reports/archive`, {
        id,
        reportState,
        username,
      });
      ...
      <div className="d-flex flex-column gap-3">
        ...
        <div className="d-flex justify-content-between mt-4">
          ...
          <div className="d-flex gap-2">
            <button
              className="btn create-btn d-flex gap-2 align-items-center shadow-sm"
        ...
        <div className="d-flex flex-column gap-3 data-box">
          ...
          <div className="header m-0 p-0 row d-flex align-items-center text-center justify-content-center rounded text-light shadow-sm">
            ...
            <div
              className="col-3 cursor-pointer"
              onClick={() => handleSort("report_description")}
            >
              Report Description
              <FontAwesomeIcon
          ...
          {isLoading ? (
            ...
            <div className="text-center py-4">
              ...
              <button className="btn btn-warning mt-2" onClick={clearFilters}>
                Clear Filter
              </button>
            </div>
          ) : (
            currentReports.map((report) => (
              <div
                ...
                className="m-0 p-0 d-flex align-items-center text-center row rounded data shadow-sm"
              >
                ...
                <div className="col-3">
                  ...
                  <button
                    className="btn eye-btn"
                    onClick={() =>
                      handleArchive(report.report_id, report.is_archived)
                    }
                  >

...
const Logbook = () => {
  ...
  const fetchTodayEntries = async () => {
    ...
    try {
      ...
      let url = `https://api2.tuplrc-cla.com/api/patron/sort?startDate=${today}&endDate=${today}&limit=${entriesPerPage}&page=${currentPage}`;
  ...
  const fetchClearEntries = async () => {
    ...
    try {
      ...
      let url = `https://api2.tuplrc-cla.com/api/patron/sort?startDate=${today}&endDate=${today}&limit=5&page=1`;
      ...
      <div className="d-flex justify-content-between align-items-center">
        ...
        <div className="search-export">
          <div className="input-group z-0" role="search">
            ...
            />
            <button className="btn log-search-button" onClick={handleSearch}>
              ...
              patron.length > 0 ? (
                patron.map((item, index) => (
                  <tr key={index}>
                    ...
                    <td>{item.college}</td>
                    <td>
                      {new Date(item.att_date).toLocaleDateString("en-CA")}
                    </td>

  ...
  const getBookData = async () => {
    try {
      const response = await fetch(
        `https://api2.tuplrc-cla.com/api/isbn/${bookData.isbn}`
      )
        .then((data) => data.json())
      ...
      <div className="col-6 info-input-box">
        <div className="row">
          ...
          <div className="col-12 info-input-box mb-3">
            ...
            <span className="add-publisher">
              Publisher not listed? Please{" "}
              <button
                className="add-publisher-button"
                onClick={() => {
          ...
          <div className="col-12 info-input-box mb-3">
            ...
            />
            <p className="resource-error">
              {error.publishedDate ? error.publishedDate : ""}
            </p>
          </div>
        </div>
      </div>

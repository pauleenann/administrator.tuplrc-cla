    ...
    <div className="cat-container">
      ...
      <div className="add-scan-item">
        <div className="d-flex justify-content-between">
          ...
          <Link to="/catalog/add">
            <button
              type="button"
              class="btn cat-button d-flex align-items-center justify-content-center gap-2 "
            >
      ...
      <div className="search-filter d-flex gap-2">
        ...
        <button
          className="btn cat-button px-3"
          onClick={() => {
            isOnline ? getCatalogOnline(true) : getCatalogOffline(true);
          }}
        >
            ...
            <td>
              ...
              {isOnline ? (
                <select
                  ...
                  className="sort"
                  onChange={(e) =>
                    handleSelectedFilter("title", e.target.value)
                  }
                >
            ...
            <td>
              ...
              {isOnline ? (
                <select
                  ...
                  className="sort"
                  onChange={(e) =>
                    handleSelectedFilter("author", e.target.value)
                  }
                >
                  <option value="" disabled selected></option>
        ...
        <tbody>
          {catalog.length === 5 ? (
            catalog.map((item, key) => (
              <tr
                key={key}
                onClick={() => navigate(`/catalog/view/${item.resource_id}`)}
              >
            ...
            <>
              ...
              {[...Array(5 - catalog.length)].map((_, index) => (
                <tr key={`empty-${index}`}>
                  <td colSpan="7" style={{ textAlign: "center", opacity: 0 }}>
                    -
                  </td>
                </tr>
              ))}

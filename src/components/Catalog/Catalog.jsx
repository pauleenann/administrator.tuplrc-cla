    ...
    if (resources.length > 0) {
      for (const resource of resources) {
        ...
        const response = await axios.post(
          "https://api2.tuplrc-cla.com/api/resources",
          formData
        );
      ...
      setTimeout(() => {
        ...
        Swal.fire({
          ...
          html:
            duplicatedResources && duplicatedResources.length > 0
              ? `Offline resources synced successfully. These will be deleted from storage. Resources such as <b>${duplicatedResources.join(
                  ", "
                )}</b>, already exist and cannot be synced again.`

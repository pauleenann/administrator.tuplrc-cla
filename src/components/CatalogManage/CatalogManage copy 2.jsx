  ...
  const handleSelectedDepartment = async (id) => {
    ...
    try {
      const response = await axios
        .get(`https://api2.tuplrc-cla.com/api/data/topic/${id}`)
        .then((res) => res.data);
      setTopics(response);
  ...
  return (
    <div className="manage-catalog bg-light">
      ...
      <div className="back-path">
        <p>
          Cataloging / <span>Manage Catalog</span>
        </p>
      </div>
      ...
      <div className="row">
        ...
        <div className="col d-flex flex-column align-items-start gap-3">
          ...
          <div className="d-flex flex-column align-items-start">
            ...
            <span className="instructions mt-3">
            ...
            <div className="row justify-content-between w-100 me-5 pe-5 ps-5 ">
              <div className="text-capitalize col flex-column align-items-start d-flex justify-content-center ">
                <button
                  ...
                  onClick={() => {
                    handleSelectedDepartment(item.dept_id);
                    setDeptName(item.dept_name);
                    setShelfNo(item.dept_shelf_no);
                    setEditDeptId(item.dept_id);
                  }}
                >
          ...
          {/* Add Department */}
          <button
            className="btn d-flex gap-3 align-items-center add-dept-btn mt-5"
          ...
          <div className="col d-flex flex-column justify-content-between selected rounded p-4 shadow-sm ">
            <div className="d-flex flex-column gap-3">
              ...
              <div className="row d-flex">
                <div className="col d-flex flex-column fw-semibold ">
                  ...
                  <input
                    ...
                    value={
                      selectedDepartment ? selectedDepartment.dept_name : ""
                    }
                    readOnly
                  />
                </div>
                ...
                <div className="col-2 d-flex flex-column fw-semibold ">
                  ...
                  <input
                    ...
                    className="rounded p-2 text-capitalize"
                    value={
                      selectedDepartment ? selectedDepartment.dept_shelf_no : ""
                    }
                    readOnly
                  />
                </div>
              ...
              <div className="gap-2 container">
                    ...
                    >
                      <div className="p-2 border-bottom border-top text-capitalize col flex-column">
                        <input
                          ...
                          type="text"
                          className="rounded p-2 ps-3 text-capitalize w-100"
                        />
                      </div>
                      <div className="p-2 border-bottom border-top text-capitalize col-2 flex-column align-items-center d-flex justify-content-center">
                        <input
                          placeholder={topic.topic_row_no}
                          value={topic.topic_row_no}
                          type="number"
                          className="rounded p-2  text-capitalize w-50"
                        />
                      </div>
                ...
                {/* add new topic */}
                <button
                  className="btn add-topic d-flex align-items-center gap-3 mt-3"
                  data-bs-toggle="modal"
                  data-bs-target="#AddTopic"
                  onClick={() => {
                    setEditTopicId(null);

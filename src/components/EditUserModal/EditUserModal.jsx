  ...
  const getRole = async () => {
    try {
      const response = await axios.get(
        "https://api2.tuplrc-cla.com/api/data/roles"
      );
      ...
      <div className="edit-u-modal-box">
        ...
        <div className="row px-4 gy-3">
          ...
          <div className="col-6 form-floating">
            <input
              type="text"
              className={`form-control ${error.uname ? "is-invalid" : ""}`}
              id="uname"
              name="uname"
              placeholder=""
              value={account && account.uname}
              onChange={handleChange}
            />
            <label htmlFor="uname" className="ms-2">
              Username
            </label>
              ...
              {roles.length > 0
                ? roles.map((item) => {
                    return (
                      <option
                        value={item.role_id}
                        selected={account && item.role_id == account.role}
                      >
                        {item.role_name}
                      </option>
                    );
          ...
          <div className="col-6 form-floating">
            ...
            />
            <label htmlFor="" id="pass" className="ms-2">
              Password
            </label>
          ...
          <div className="col-6 form-floating">
            <input
              ...
              disabled={!isChangePassword}
            />
            <label htmlFor="" id="confirm-pass" className="ms-2">
              Confirm Password
            </label>

    ...
    <div className="admin-navbar-container shadow">
      ...
      <div className="navbar-logo-heading">
        ...
        <div className="navbar-heading">
          <p className="navbar-heading-text navbar-heading-cla">
            College of Liberal Arts
          </p>
          <p className="navbar-heading-text navbar-heading-lrc">
      ...
      <div className="navbar-menu">
        <ul className="menu-list">
          ...
          {/* Logbook */}
          <li
            className={`menu-item ${basePath === "/logbook" ? "selected" : ""}`}
          >
          ...
          {/* Patrons */}
          <li
            className={`menu-item ${basePath === "/patron" ? "selected" : ""}`}
          >
          ...
          <li
            className={`menu-item ${basePath === "/catalog" ? "selected" : ""}`}
          >
            <Link to="/catalog" className="text-decoration-none">
              <div
                className="menu"
                onClick={toggleCataloging}
          ...
          <li
            className={`menu-item ${basePath === "/reports" ? "selected" : ""}`}
          >
